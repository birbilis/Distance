...
τους απόσταση δώστε μια μέση ταχύτητα σε χιλιόμετρα ανά ώρα. Το πρόγραμμα θα 
σας δώσει το χρόνο στον οποίο θα τη διανύσετε.
...
ΠΡΟΣΟΧΗ: Τα DISTANCE.EXE (DISTANCE.BAS), DISTANCE.DAT και CITIES.DAT πρέπει να 
